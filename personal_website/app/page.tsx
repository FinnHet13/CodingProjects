        ...
        <div className="max-w-4xl mx-auto px-6 py-12">
          <div className="flex flex-col md:flex-row items-start gap-8">
            <div className="flex-shrink-0">
              <Image
                src="/assets/github_profile_pic.jpg"
                alt="Profile Picture"
                width={200}
                height={200}
            ...
            <div className="flex-1">
              ...
              <p className="text-gray-400 mb-6 leading-relaxed">
                Passionate about bridging business insights with computer science. I am currently moving my focus from BI to AI. With this website, I want to share my (largely self-taught) coding progress through various projects.
              </p>
