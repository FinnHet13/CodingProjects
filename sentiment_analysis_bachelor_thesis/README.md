...
To achieve this, I benchmarked three pre-trained transformer models from Hugging Face on their sentiment analysis performance on the EmoWoz dataset containing task-based dialogues.
...
- Final sentiment predictions shown in [4_Sentiment_analysis_result.xlsx](4_Sentiment_analysis_result.xlsx)
